...
public class DoublePagesRender extends PageRender {
    ...
    public void onSurfaceChanged(int width, int height) {
        ...
        LoadBitmapTask.get(mContext).set(pageW, pageH);
    }
    ...
    private void drawPage(int number) {
        ...
        Bitmap background = LoadBitmapTask.get(mContext).getBitmap(LoadBitmapTask.DEFAULT_BG);
        ...
        if (number == 1) {
            String firstPage = "The No.1 Page";
