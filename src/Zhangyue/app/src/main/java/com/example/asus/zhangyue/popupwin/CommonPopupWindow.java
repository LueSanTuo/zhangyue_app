package com.example.asus.zhangyue.popupwin;
...
public abstract class CommonPopupWindow {
    ...
    public void setFocusable (boolean state) {
        mInstance.setFocusable(state);
        mInstance.update();
    }
    public void setTouchable (boolean state) {
        mInstance.setTouchable(state);
        mInstance.update();
    }
    public void setOutsideTouchable (boolean state) {
        mInstance.setOutsideTouchable(state);
        mInstance.update();
    }
